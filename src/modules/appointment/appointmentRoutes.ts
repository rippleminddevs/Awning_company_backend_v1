...
router.get(
  '/',
  requiredRole(['manager', 'salesperson', 'superadmin']),
  validateQuery(AppointmentValidator.getAll),
  appointmentController.getAll
)
router.get(
  '/manager',
  requiredRole(['manager', 'superadmin']),
  validateQuery(AppointmentValidator.getAll),
  appointmentController.getAppointmentsforManager
)
router.get(
  '/:id',
  requiredRole(['manager', 'salesperson', 'superadmin']),
