...
import optionItemRoutes from '../optionItem/optionItemRoutes'
...
// Items sub-router — must come before /:id to avoid conflict
router.use('/:groupId/items', optionItemRoutes)

router.get('/', optionGroupController.getAll)
router.get('/by-product-slug', optionGroupController.getByProductSlug)
